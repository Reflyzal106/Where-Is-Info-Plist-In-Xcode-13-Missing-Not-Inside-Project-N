# [SOLVED] Where-Is-Info-Plist-In-Xcode-13-Missing-Not-Inside-Project-N
...
>
> ### ➡️ [CLICK HERE TO VIEW THE FULL FIX GUIDE](https://techfixdocs.my.id/where-is-info-plist-in-xcode-13-missing-not-inside-project-n)
>
...
In Xcode 13, the Info.plist file is now located in the Project Navigator's target settings. To edit it, select the target, then click on the Info tab.
...
👉 **[Go to ErrorFix Hub Full Article](https://techfixdocs.my.id/where-is-info-plist-in-xcode-13-missing-not-inside-project-n)**
